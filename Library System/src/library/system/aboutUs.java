...
//            setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\ram\\Desktop\\rohit.jpg"));
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("library/system/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : DarkUnicornz");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : darkunicornz@gmail.com");
